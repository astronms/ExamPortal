...
namespace ExamPortal.Controllers
{
    ...
    public class ExamController : Controller
    {
        ...
        //przenieść do Session
        [HttpGet("{sessionGuid:Guid}", Name = "CountExams")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> CountExams(Guid sessionGuid)
        {
            try
            {
                var exams = await _unitOfWork.Sessions.GetAll(x => x.SessionId == sessionGuid);
        ...
        //[HttpGet("{id:int}"), Authorize, Route("start")]
